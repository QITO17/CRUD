...
const UserCreate = ({setResetett, resetett}) => {
    const changeReset = () => {
  ...
  return (
    <section className={`absolute top-0 left-0
        ...
        text-white flex gap-5 items-center flex-col justify-center">
            <h2 className='text-[2rem]'>Incorrecto</h2>
            <p><i className='bx bx-sad'></i>No Puedes Dejar Campos Vacios<i className='bx bx-sad'></i></p>
